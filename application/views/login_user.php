...
<div class="w3layouts-main">
  <h2>Sign In Now</h2>
   ...
   <!-- <span>Made with <i class="fa fa-heart"></i> by <a href="http://andytran.me">Billa</a></span> -->
            ...
            <?php
                    ...
                    ?>
  <form class="login-form" role="form" method="post" action="<?php echo base_url();?>index.php/admin/login_home">
  ...
  <input type="text" name="username" class="ggg" name="Email" placeholder="USERNAME" required="">
      ...
      <span><input type="checkbox" />Remember Me</span>
        ...
        <p>Don't Have an Account ?<a href="<?php echo base_url();?>index.php/admin/view_register">Create an account</a></p>
  </form>
</div>
</div>
